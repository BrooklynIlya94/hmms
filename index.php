...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-T7RMMHG6GY"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-T7RMMHG6GY');
    </script>
                ...
                <div class="col-lg-5 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <h2>Пожалуйста следите за своим здоровьем</h2>
                            <p style = "font-family:georgia,garamond,serif;font-size:16px;font-style: italic;">"Болезни, происходящие от переутомления, лечатся покоем,
                                    а те, что происходят от праздности, излечиваются трудом." </p>
                                <p align="right" style = "font-family:georgia,garamond,serif;font-size:16px;font-style:italic;">Гиппократ</p>
                        </div>
                    </div>
                </div>
                <!--<div class="col-lg-7">
                    <div class="banner_img">
                        <img src="img/info.jpg" width="920" height="540" alt="">
                    </div>
                </div>-->
            </div>
        </div>
