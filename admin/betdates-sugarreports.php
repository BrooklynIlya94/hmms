...
<head>
    ...
    <title>Даты отчетов по уровню сахара</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Даты отчетов по уровню сахара</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title"style="color: #7373e8">Даты отчетов по уровню сахара</h4>
