...
<head>
    ...
    <title>История по артериальному давлению</title>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">История по артериальному давлению</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-bp.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Добавить АД</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="view-bphistory.php?viewid=<?php echo ($row->ID);?>"><i class="fa fa-pencil m-r-5"></i> Просмотр</a>
													<a class="dropdown-item" href="history-bp.php?delid=<?php echo ($row->ID);?>" data-toggle="modal"><i class="fa fa-trash-o m-r-5"></i> Удалить</a>
												</div>
											</div>
										</td>
									</tr>
