...
<head>
    ...
    <title>Система мониторинга здоровья - Даты отчетов по температуре тела</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Даты отчетов по температуре тела</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title" style="color: #7373e8">Даты отчетов по температуре тела</h4>
